...
class ChatClient:
    ...
    def receive(self):
        while True:
            try:
                # set curent cursor position
                # self.previous_cursor_position = chat_text.index(tk.INSERT)
    ...
    def send_message(self):
        ...
        # set curent cursor position
        self.previous_cursor_position = index
    ...
    def display_message(self, message):
        try:
            ...
            chat_text.mark_set(tk.INSERT, self.previous_cursor_position)
...
if __name__ == "__main__":
    ...
    chat_text.bind("<KeyRelease-space>", chat_client.ignore_key)
